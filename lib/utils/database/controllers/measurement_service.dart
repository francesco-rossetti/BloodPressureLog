import 'package:bloodpressurelog/utils/database/controllers/service_interface.dart';
import 'package:bloodpressurelog/utils/database/db_provider.dart';
  ...
  Future<List<Measurement>> readAll() async {
    try {
      ...
      var queryResult = await connection!
          .query(Measurement.tableName, where: "dateDelete IS NULL");
