...
class DiaCircularPercentageIndicator extends StatelessWidget {
  final int value;

  const DiaCircularPercentageIndicator({Key? key, required this.value})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return CircularStepProgressIndicator(
        ...
        child: Column(
            ...
            children: [
              Text(AppLocalizations.of(context)!.translate("lblDIA")!),
